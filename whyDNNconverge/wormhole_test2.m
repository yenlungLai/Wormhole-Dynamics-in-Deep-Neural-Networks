...
vin=m2vec(testimg0);  % P



Ib=generate_random_vector(784, 'uniform', 0,255)'; % noise to use for puturb
...
Ia=m2vec(testimg1); %change 1 to 2,3,4,...,9 to see same effect
% unit vector initialized using mnis image to be use to reconcile P

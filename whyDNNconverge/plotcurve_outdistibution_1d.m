...
inp_vec1 = generate_random_vector(1, 'uniform', -5000, 5000)';
L_cluster = [];
...
figure;
hold on;
scatter(L_cluster(:, 2), L_cluster(:, 1), '.','MarkerEdgeColor',[0.4940 0.1840 0.5560]);


grid on;
xlabel('$\hat{i}_L$', 'Interpreter', 'latex');
